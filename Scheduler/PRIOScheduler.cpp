...
int PRIOScheduler::indexOfActiveQ;
int PRIOScheduler::indexOfExpiredQ;
...
void PRIOScheduler::add_process(Process *proc) {
...
void PRIOScheduler::PriorityPushBack(Process *proc, deque<Process*> *q){
